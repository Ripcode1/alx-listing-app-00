    ...
    <footer className="bg-gray-900 text-gray-300 py-12 mt-20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-white font-bold text-lg mb-4">ALX Listing</h3>
            <p className="text-sm text-gray-400">
              Find your perfect accommodation from over 2 million properties worldwide.
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-sm hover:text-white transition">About Us</a>
              </li>
              <li>
              ...
              <li>
                <a href="#" className="text-sm hover:text-white transition">Press</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-sm hover:text-white transition">Safety Information</a>
              </li>
              <li>
                <a href="#" className="text-sm hover:text-white transition">Cancellation Options</a>
              </li>
              <li>
                <a href="#" className="text-sm hover:text-white transition">Our COVID-19 Response</a>
              </li>
            </ul>
          </div>
